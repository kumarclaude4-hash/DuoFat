import { ArrowLeft, Volume2, Video, FlipHorizontal2, Camera, Mic, MessageSquare, PhoneOff } from "lucide-react";
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", padding: "2px 6px 0" }}>
            ...
            <div style={{ flex: 1, textAlign: "center" }}>
              ...
              <div style={{ fontSize: "13px", color: "rgba(255,255,255,0.8)", fontWeight: 600, marginTop: "1px" }}>02:14</div>
            </div>
            <div style={{ width: "44px", height: "44px", display: "flex", alignItems: "center", justifyContent: "center" }}>
