import { ArrowLeft, Volume2, Video, FlipHorizontal2, Mic, MessageSquare, PhoneOff, MessageCircle } from "lucide-react";
...
export function VideoBanner() {
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", padding: "0 4px" }}>
          ...
          <div style={{ flex: 1, textAlign: "center" }}>
            ...
            <div style={{ fontSize: "14px", color: "rgba(255,255,255,0.85)", fontWeight: 600, marginTop: "1px" }}>02:47</div>
          </div>
          <div style={{ width: "48px", height: "48px", display: "flex", alignItems: "center", justifyContent: "center" }}>
      ...
      <div style={{
        position: "absolute", top: "88px", left: "50%", transform: "translateX(-50%)", zIndex: 20,
        ...
        borderRadius: "28px",
        padding: "10px 18px",
        boxShadow: "0 8px 32px rgba(0,0,0,0.5), 0 0 0 0.5px rgba(0,201,224,0.1)",
        whiteSpace: "nowrap"
      }}>
        <MessageCircle size={16} color="#00C9E0" strokeWidth={2.2} style={{ flexShrink: 0 }} />
        <span style={{ fontSize: "13px", color: "rgba(255,255,255,0.92)", fontWeight: 500 }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <IconBtn color="rgba(0,201,224,0.22)">
            <MessageSquare size={24} color="#00C9E0" strokeWidth={2} />
          </IconBtn>
