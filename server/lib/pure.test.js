...
// ── B2 SigV4 presign helper tests removed (S03-L3 / S04-I2) ───────────────────
// `buildB2PresignUrl` and `b2HmacKey` no longer exist in server/lib/pure.js —
// they were the signing math behind the server's dead `b2PresignUrl` helper,
// removed together with it (SEC-A01 replaced presigned-URL issuance with
// per-object capability tokens served by the Cloudflare Worker).
