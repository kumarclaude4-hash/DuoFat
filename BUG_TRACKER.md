...
| S04-M1 (gov: High) | Open | Carried | IPv6 /64 defeats IP-keyed limits | No IPv6-aware key normalization found in a quick pass of the rate-limit helpers; not exhaustively re-read. Deferred out of S3-07 scope this session for budget reasons — see `sessions/SESSION-S3-07.md`; remains next in queue. |
