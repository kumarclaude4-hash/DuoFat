...
public class SplashActivity extends AppCompatActivity {
    ...
    private void startBreathing(View logo) {
        // Scale up to 1.02 first, then reverse forever.
        ...
        for (ObjectAnimator anim : new ObjectAnimator[]{breatheX, breatheY}) {
            ...
            // AccelerateDecelerate gives the organic in-out feel.
    ...
    private void navigate() {
        ...
        FirebaseAuth.getInstance().addAuthStateListener(new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth auth) {
                ...
                // F30: If a duress wipe is in progress the Firebase session may
                // still appear valid.  Route to SignIn so the wipe can finish.
