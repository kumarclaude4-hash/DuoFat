...
public class VoiceRecorderHelper {
     ...
     *   Stage 3 — EMA smooth:     displayAmp = displayAmp × 0.75 + amp × 0.25
     * </pre>
     */
    private void dispatchAmplitude(float rms) {
        ...
        // Stage 3: exponential moving average (α = 0.25).
        // Fast attack (loud syllable fills quickly), gradual release (no abrupt drops
        // between syllables), no lag on sustained speech.
